...
class PosOrderLine(models.Model):
    ...
    discount_promotion = fields.Float(
        string="Promotion Discount Amount Per Quantity",
        digits='Product Price',
        help="Discount amount applied by the promotion on this line per quantity"
    )
    ...
    def _export_for_ui(self, orderline):
        return {
            ...
            'discount_promotion': orderline.discount_promotion,
        }
