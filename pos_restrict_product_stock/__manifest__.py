...
#############################################################################
{
    ...
    'data': [
        ...
        'views/templates.xml',
        'views/product_promotion_location.xml',
    ],
    'assets': {
        'point_of_sale._assets_pos': [
            '/pos_restrict_product_stock/static/src/js/RestrictStockPopup.js',
            '/pos_restrict_product_stock/static/src/js/order.js',
            '/pos_restrict_product_stock/static/src/js/orderline.js',
            '/pos_restrict_product_stock/static/src/js/product.js',
            '/pos_restrict_product_stock/static/src/js/PosStore.js',
            ...
            '/pos_restrict_product_stock/static/src/js/ProductDamagePopup.js',
            '/pos_restrict_product_stock/static/src/js/PaymentConfigurationScreen.js',
            '/pos_restrict_product_stock/static/src/js/ProductScreen.js',
            '/pos_restrict_product_stock/static/src/js/ProductList.js',
            ...
            '/pos_restrict_product_stock/static/src/css/product_damage_popup.css',
            '/pos_restrict_product_stock/static/src/css/payment_configuration_screen.css',
            ...
            '/pos_restrict_product_stock/static/src/xml/ProductDamagePopup.xml',
            '/pos_restrict_product_stock/static/src/xml/PaymentConfigurationScreen.xml',
